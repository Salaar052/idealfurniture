    ...
    <nav className="sticky top-0 z-50 bg-background-light dark:bg-background-dark shadow-sm">
      <div className="flex items-center justify-between p-4 px-6 md:px-10">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link
            href="/"
            className="flex items-center gap-2 text-primary dark:text-white hover:text-primary transition-colors"
          >
        ...
        <div className="md:hidden flex items-center">
          <button
            ...
            title={isMobileMenuOpen ? "Close menu" : "Open menu"} // optional tooltip
          >
